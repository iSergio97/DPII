...
<jstl:if test="${messageBox.isSystem == false}">
...
<jstl:if test="${messageBox.isSystem == true}">
	<h2><spring:message code="messageBox.name"/>: <em><jstl:out value="${messageBox.name}"></jstl:out></em></h2>
</jstl:if>
<br/>
