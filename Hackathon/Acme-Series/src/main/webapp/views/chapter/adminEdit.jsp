...
<form:form modelAttribute="chapter" method="POST" action="chapter/administrator/edit.do">
...
<jstl:if test="${chapter.id ne 0}">
<form action="chapter/administrator/edit.do" method="POST">
