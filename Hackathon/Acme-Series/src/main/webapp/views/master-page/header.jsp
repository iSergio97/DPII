...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="isAnonymous()">
			...
			<li><a class="fNiv" href="register/user/create.do"> <spring:message
		...
		<security:authorize access="isAuthenticated()">
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					<li><a href="message/all/create.do"><spring:message
								code="master.page.message.create" /></a></li>
					<li><a href="message/all/broadcast.do"><spring:message
								code="master.page.message.broadcast" /></a></li>
					<li><a href="message-box/all/show.do?name=inBox"><spring:message
								code="master.page.messageBox.inBox" /></a></li>
					<li><a href="message-box/all/show.do?name=outBox"><spring:message
								code="master.page.messageBox.outBox" /></a></li>
					<li><a href="message-box/all/show.do?name=trashBox"><spring:message
								code="master.page.messageBox.trashBox" /></a></li>
					<li><a href="message-box/all/show.do?name=spamBox"><spring:message
								code="master.page.messageBox.spamBox" /></a></li>
					<li><a href="message-box/all/show.do?name=notificationBox"><spring:message
								code="master.page.messageBox.notificationBox" /></a></li>
					<li><a href="message-box/all/list.do"><spring:message
								code="action.list.messageBox" /></a></li>
				</ul></li>
		</security:authorize>
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					...
					<li><a href="administrator/actor/list.do"><spring:message
								code="master.page.administrator.listActor" /></a></li>
					<li><a href="register/administrator/create.do"><spring:message
								code="master.page.administrator.register" /></a></li>
					<li><a href="register/auditor/create.do"><spring:message
...
<div>
	<a href="?language=en"><img alt="en" src="images/en.png"
		height="32"></a> <a href="?language=es"><img alt="es"
		src="images/es.png" height="32"></a>
</div>
