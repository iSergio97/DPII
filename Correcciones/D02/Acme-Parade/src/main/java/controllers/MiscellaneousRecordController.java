...
public class MiscellaneousRecordController extends AbstractController {
	...
	public ModelAndView show(@RequestParam(value = "id") final int id) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/miscellaneousRecord/show");
	...
	public ModelAndView list() {
		...
		result = this.createModelAndViewWithSystemConfiguration("/miscellaneousRecord/list");
	...
	public ModelAndView edit(@RequestParam(value = "id") final int recordId) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/miscellaneousRecord/edit");
	...
	public ModelAndView save(@ModelAttribute("miscellaneousRecord") final MiscellaneousRecordForm record, final BindingResult bindingResult) {
		...
		if (bindingResult.hasErrors())
			...
			try {
				...
				result = this.createModelAndViewWithSystemConfiguration("redirect:/miscellaneousRecord/list.do");
	...
	protected ModelAndView createAndEditModelAndView(final MiscellaneousRecordForm record, final String message) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/miscellaneousRecord/create");
		result.addObject("miscellaneousRecord", record);
