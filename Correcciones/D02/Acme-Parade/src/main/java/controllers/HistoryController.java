...
public class HistoryController extends AbstractController {
	...
	public ModelAndView show() {
		...
		result = this.createModelAndViewWithSystemConfiguration("/history/show");
	...
	public ModelAndView create() {
		...
		result = this.createModelAndViewWithSystemConfiguration("redirect:/inceptionRecord/create.do");
		return result;
	}
}
