...
public class ParadeController extends AbstractController {
	...
	public ModelAndView list() {
		...
		result = this.createModelAndViewWithSystemConfiguration("parade/brotherhood/list");
	...
	public ModelAndView show(@RequestParam final int paradeId) {
		...
		result = this.createModelAndViewWithSystemConfiguration("parade/public/" + "show");
	...
	protected ModelAndView createEditModelAndView(final Parade parade, final String messageCode, final String method) {
		...
		result = this.createModelAndViewWithSystemConfiguration("parade/brotherhood/" + method);
