...
public class AcmeFloatController extends AbstractController {
	...
	public ModelAndView show(@RequestParam(value = "id") final int id) {
		...
		result = this.createModelAndViewWithSystemConfiguration("float/show");
	...
	public ModelAndView list() {
		...
		result = this.createModelAndViewWithSystemConfiguration("float/list");
	...
	public ModelAndView create() {
		...
		result = this.createModelAndViewWithSystemConfiguration("float/edit");
