...
public class BrotherhoodController extends AbstractController {
	...
	public ModelAndView list() {
		...
		result = this.createModelAndViewWithSystemConfiguration("brotherhood/public/list");
	...
	protected ModelAndView createEditModelAndView(final Brotherhood brotherhood) {
		...
		result = this.createModelAndViewWithSystemConfiguration("brotherhood/public/" + "show");
