...
public class ProfileController extends AbstractController {
	...
	public ModelAndView memberShow() {
		...
		result = this.createModelAndViewWithSystemConfiguration("profile/member/show");
	...
	public ModelAndView brotherhoodShow() {
		...
		result = this.createModelAndViewWithSystemConfiguration("profile/brotherhood/show");
	...
	public ModelAndView showAdmin() {
		...
		result = this.createModelAndViewWithSystemConfiguration("profile/admin/show");
	...
	public ModelAndView editMember() {
		...
		final String reqURI = "member";
		result = this.createModelAndViewWithSystemConfiguration("profile/member/edit");
	...
	public ModelAndView editBrotherhood() {
		...
		final String reqURI = "brotherhood";
		result = this.createModelAndViewWithSystemConfiguration("profile/brotherhood/edit");
	...
	public ModelAndView editAdmin() {
		...
		final AdministratorForm adminf = this.administratorService.deconstruct(admin);
		final String reqURI = "admin";
		result = this.createModelAndViewWithSystemConfiguration("profile/admin/edit");
	...
	public ModelAndView exportBrotherhood() {
		...
		try {
			...
			PdfWriter.getInstance(as, new FileOutputStream(locale + "\\Desktop\\brotherhood.pdf"));
			as.open();
	...
	public ModelAndView exportMember() {
		...
		try {
			final String locale = System.getProperty("user.home");
			PdfWriter.getInstance(as, new FileOutputStream(locale + "\\Desktop\\member.pdf"));
			as.open();
			final Paragraph gpdr = new Paragraph("GPDR Legislation\n\n");
			gpdr.setAlignment(Element.ALIGN_CENTER);
			as.add(gpdr);
	...
	public ModelAndView exportAdmin() {
		...
		try {
			final String locale = System.getProperty("user.home");
			PdfWriter.getInstance(as, new FileOutputStream(locale + "\\Desktop\\admin.pdf"));
			as.open();
			final Paragraph gpdr = new Paragraph("GPDR Legislation\n\n");
			gpdr.setAlignment(Element.ALIGN_CENTER);
			as.add(gpdr);
