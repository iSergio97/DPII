...
public class RequestController extends AbstractController {
	...
	public ModelAndView memberList() {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/member/list");
	...
	public ModelAndView show(@RequestParam(value = "requestId") final int requestId) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/member/show");
	...
	public ModelAndView edit(@RequestParam final int requestId) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/member/edit");
		result.addObject("request", request);
	...
	public ModelAndView save(@ModelAttribute("request") final RequestForm request, final BindingResult bindingResult) {
		...
		if (bindingResult.hasErrors())
			...
			try {
				...
				result = this.createModelAndViewWithSystemConfiguration("redirect:/request/member/list.do");
	...
	public ModelAndView brotherhoodList() {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/brotherhood/list");
		result.addObject("requests", requests);
	...
	public ModelAndView brotherhoodShow(@RequestParam(value = "requestId") final int requestId) {
		...
		request = this.requestService.findOne(requestId);
		result = this.createModelAndViewWithSystemConfiguration("/request/brotherhood/show");
	...
	public ModelAndView acceptMember(@RequestParam(value = "id") final int id) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/brotherhood/accept");
		result.addObject("request", request);
	...
	public ModelAndView acceptMember(@ModelAttribute("request") final RequestForm requestForm, final BindingResult binding) {
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = this.createModelAndViewWithSystemConfiguration("redirect:/request/brotherhood/list.do");
			} catch (final Throwable oops) {
	...
	public ModelAndView rejectMember(@RequestParam(value = "id") final int id) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/brotherhood/reject");
		result.addObject("request", request);
		return result;
	}
	...
	protected ModelAndView createAndEditModelAndView(final RequestForm request, final String message) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/request/member/create");
		result.addObject("request", request);
		result.addObject("parades", parades);
