...
public class LinkRecordController extends AbstractController {
	...
	public ModelAndView show(@RequestParam(value = "id") final int id) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/linkRecord/show");
	...
	public ModelAndView list() {
		...
		result = this.createModelAndViewWithSystemConfiguration("/linkRecord/list");
	...
	public ModelAndView edit(@RequestParam(value = "id") final int recordId) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/linkRecord/edit");
	...
	public ModelAndView save(@ModelAttribute("linkRecord") final LinkRecordForm record, final BindingResult bindingResult) {
		...
		if (bindingResult.hasErrors())
			...
			try {
				...
				result = this.createModelAndViewWithSystemConfiguration("redirect:/linkRecord/list.do");
	...
	protected ModelAndView createAndEditModelAndView(final LinkRecordForm record, final String message) {
		...
		result = this.createModelAndViewWithSystemConfiguration("/linkRecord/create");
		result.addObject("linkRecord", record);
		result.addObject("brotherhoods", brotherhoods);
