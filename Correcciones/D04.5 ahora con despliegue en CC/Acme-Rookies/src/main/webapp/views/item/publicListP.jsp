...
<jstl:out value="${row.link}" />
	...
	<display:column titleKey="show">
		<a href="item/public/show.do?itemId=${row.id}"><spring:message code="show" /></a>
	</display:column>

	<display:column titleKey="provider">
		<a href="provider/public/show.do?providerId=${row.provider.id}"><spring:message code="provider" /></a>
	</display:column>
