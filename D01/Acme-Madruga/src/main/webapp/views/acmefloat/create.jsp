...
<form:form modelAttribute="acmeFloat" method="POST" action="float/create.do">
	...
	<div id="processions" class="processions">
		...
		<form:select multiple="true" id="processions" path="processions">
			<form:options items="${processions}" itemLabel="title" itemValue="title" />
		</form:select>
	</div>
