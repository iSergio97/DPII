...
public class Authority implements GrantedAuthority {
	...
	public static final String	HANDY_WORKER	= "HANDY_WORKER";
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMIN + "|" + Authority.CUSTOMER + "|" + Authority.HANDY_WORKER + "|" + Authority.REFEREE + "|" + Authority.SPONSOR + "$")
	@Override
