...
<display:table name="requests" id="row"
	...
	<display:column> <a href="request/member/show.do?requestId=${row.id}" > <spring:message code="request.show"/></a></display:column>

</display:table>

<a href="request/member/create.do"><spring:message code="request.new" /></a>