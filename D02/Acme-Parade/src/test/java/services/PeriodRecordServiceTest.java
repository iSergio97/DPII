		...
		final Object testingData[][] = {
			{
				...
				null, "periodRecord1", NullPointerException.class
			}, {
				"brotherhood1", "periodRecord1", AssertionError.class
			}, {
				"member1", "periodRecord1", AssertionError.class
			}, {
				"admin1", "periodRecord1", NullPointerException.class
			}
		};
